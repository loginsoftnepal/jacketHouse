  ...
  return (
    <div className='w-full flex flex-col'>
      ...
      <div className='w-[80%] mx-auto my-8'>
        ...
        <Searchbar className='rounded-xl py-3 text-xl' placeholder='Write your review about this product' buttonClasses='w-[200px] rounded-3xl px-4 py-6 hover:bg-black hover:text-white' buttonName='Post a comment' />
        <ProductComment />
      </div>
    </div>
  )
