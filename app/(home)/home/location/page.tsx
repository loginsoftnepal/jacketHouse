    ...
    <div>
      ...
      >
        ...
        <div className="lg:basis-[60%] px-3 py-3 lg:px-0 lg:py-0 lg:pl-16">
          ...
          <p className="text-lg text-darkWheat">
            Satdobato, Chapagaun Dobato, Kathmandu, Nepal
          </p>
          ...
          <p className="text-white text-lg">
            We are the manufacture, we are the creator, we are the designer and
            we provide awesome shits.
          </p>
      ...
      <div className="mt-4 w-[88%] mx-auto">
        <div className="flex items-center my-8">
          <div className="text-3xl lg:text-6xl font-bold mr-4 text-darkWheat">
            Search for location
          </div>
