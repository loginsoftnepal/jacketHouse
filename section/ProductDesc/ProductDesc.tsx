    ...
    <div className="basis-[40%] px-8 py-8 rounded-xl bg-wheat">
            ...
            colors.map((color, index) => {
              return (
                <div
                  ...
                  key={index}
                  className={`w-[14px] h-[14px] mr-3 rounded-full hover:border-2 hover:border-red hover:offset-4`}
                ></div>
              )
            })}
        </div>
      ...
      <div className="flex flex-col">
        ...
        <span className="flex items-center">
          <span className="mx-2 px-2 py-1 hover:border-2 hover:border-red border-2 border-transparent rounded-lg">
            S
          </span>
          <span className="mx-2 px-2 py-1 hover:border-2 hover:border-red border-2 border-transparent rounded-lg">
            L
