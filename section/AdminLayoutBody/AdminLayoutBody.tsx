...
function LayoutBody(props: LayoutBodyProps) {
  ...
  return (
    <div
      className="body-container w-full h-full bg-primary p-[20px] relative z-10 flex bg-no-repeat bg-center bg-contain"
      style={{ backgroundImage: 'url(/homeimg.png)' }}
    >
      <div className="basis-[80%] h-full z-10 relative">
        <div className="myScrollbar py-[20px] h-[90vh] overflow-y-auto">
          {props.children}
        </div>
        ...
        >
          ...
          <div
            ...
            className={`absolute text-[30px] cursor-pointer text-red z-40 ${
              topSheet ? 'block' : 'hidden'
            } top-[20px] right-[30px] `}
          >
