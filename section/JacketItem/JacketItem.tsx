    ...
    <div className="basis-[48%] lg:basis-[30%] 2xl:basis-[23%] flex flex-col items-center rounded-md bg-slate-50 hover:bg-slate-200">
      ...
      <div className="w-[80%] mx-auto flex flex-col">
            ...
            {props.colors.map((val, index) => {
              return (
                <div
                  ...
                  className={`mr-[2px] w-[10px] h-[10px] rounded-full`}
                ></div>
              )
            })}
          </div>
        ...
        <div className="w-full flex justify-between items-center">
          <Button
            className="px-0 font-bold text-sm"
            variant={'link'}
            onClick={() => addToCart(Product)}
          >
            {isMobile ? 'Add' : 'Add to Cart'}
          </Button>
          <Button className="font-bold text-sm" variant={'link'}>
            <Link className="font-bold " href="/home/product">
              View
            </Link>
          </Button>
        </div>
