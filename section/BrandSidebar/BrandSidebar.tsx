      ...
      <div>
        <div>
          <Badge className="px-4 py-3 mt-4  bg-white shadow-md hover:bg-white text-black">
            ...
            <span className="ml-2 text-[16px] text-darkWheat hover:text-black font-semibold uppercase">
              ALL BRANDS
            </span>
          </Badge>
        </div>
        ...
        <div className="px-4 py-4">
          <Link className="flex my-4 items-center" href={'/home/brand/jacket'}>
            ...
            />
            <span
              className={`ml-4 text-darkWheat font-semibold ${
          ...
          <Link className="flex my-4 items-center" href={'/home/brand/track'}>
            ...
            />
            <span
              className={`ml-4 font-semibold text-darkWheat ${
          ...
          >
            ...
            />
            <span
              className={`ml-4 text-darkWheat font-semibold first-letter ${
