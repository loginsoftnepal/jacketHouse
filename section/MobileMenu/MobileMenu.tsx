...
import NavItem from '../NavItemContainer/NavItemContainer'
  ...
  return (
    <div className="inline-block lg:hidden relative">
      <div
        ...
        } z-10 fixed top-0 right-0 w-[100vw] h-full bg-white overflow-auto`}
      >
        <div className="w-full px-2 flex justify-end my-2">
          <CloseOutlined onClick={() => setShowMenu((prev) => !prev)} />
        </div>
      ...
      <div className="z-40">
        <AlignJustify onClick={() => setShowMenu((prev) => !prev)} />
      </div>
    </div>
  )
}
