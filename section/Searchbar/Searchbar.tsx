...
export default function Searchbar(props: Props) {
  return (
    <div
      className={`flex basis-[60%] md:basis-[50%] lg:basis-[30%] 2xl:basis-[40%] bg-search px-2 md:py-1 w-full ${props.className}`}
    >
      ...
      <Input
        placeholder={`${
          props.placeholder ? props.placeholder : 'Search for anything...'
        }`}
      ...
      />
      <Button
        className={`hidden lg:inline-block${props.buttonClasses}`}
        variant={'screen'}
        size={'sm'}
      >
