...
function RightSidebarItem() {
  ...
  return (
    <div className='w-[90%] mx-auto rounded-xl my-4 py-2 flex flex-col bg-wheat items-center justify-center'>
        <h1 className='font-semibold text-[red]'>OFFER: <span className='font-normal text-black'>Get Combo 3pcs</span></h1>
        ...
        <div className='flex w-[70%] mb-2 mx-auto justify-between'>
            <span className='text-[red] line-through rotate-20 inline-block'>Rs. 6000</span>
